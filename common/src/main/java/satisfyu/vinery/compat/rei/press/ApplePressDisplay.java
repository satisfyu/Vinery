...
public class ApplePressDisplay extends BasicDisplay {
    ...
    public ApplePressDisplay(ApplePressRecipe recipe) {
        this(Collections.singletonList(EntryIngredients.ofIngredient(recipe.ingredient)), Collections.singletonList(EntryIngredients.of(recipe.getResultItem())), Optional.ofNullable(null));//TODO
    }
