...
public class BoatAndSignRegistry {
    ...
    public static final RegistrySupplier<Item> CHERRY_BOAT = TerraformBoatItemHelper.registerBoatItem(ObjectRegistry.ITEMS, "cherry_boat", CHERRY_BOAT_TYPE, false);
    public static final RegistrySupplier<Item> CHERRY_CHEST_BOAT = TerraformBoatItemHelper.registerBoatItem(ObjectRegistry.ITEMS, "cherry_chest_boat", CHERRY_BOAT_TYPE, true);
    public static void init() {
        DoApiCommonEP.registerBoatType(CHERRY_BOAT_TYPE, new TerraformBoatType.Builder().item(CHERRY_BOAT).chestItem(CHERRY_CHEST_BOAT).build());
    }
}
