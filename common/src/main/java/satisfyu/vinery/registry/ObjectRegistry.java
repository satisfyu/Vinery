...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item>  JO_SPECIAL_MIXTURE_ITEM = registerI("jo_special_mixture", () -> new DrinkBlockSmallItem(JO_SPECIAL_MIXTURE.get(), getWineItemSettings(VineryEffects.TRIPPY.get())));
