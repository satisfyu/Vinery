...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> NOIR_WINE_ITEM = registerItem("noir_wine", () -> new DrinkBlockBigItem(NOIR_WINE.get(), getWineItemSettings(MobEffects.HEAL, 0, 0)));
