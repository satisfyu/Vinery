...
public class ObjectRegistry {
    ...
    private static final boolean netherLatticesEnabled = VineryConfig.DEFAULT.getConfig().enableNetherLattices();
    ...
    public static final RegistrySupplier<Block> WARPED_LATTICE = !netherLatticesEnabled ? null : registerWithItem("warped_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.WARPED_PLANKS.getSoundType(Blocks.WARPED_PLANKS.defaultBlockState())).noOcclusion()));
    ...
    public static final RegistrySupplier<Block> CRIMSON_LATTICE = !netherLatticesEnabled ? null : registerWithItem("crimson_lattice", () -> new LatticeBlock(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(Blocks.CRIMSON_PLANKS.getSoundType(Blocks.CRIMSON_PLANKS.defaultBlockState())).noOcclusion()));
