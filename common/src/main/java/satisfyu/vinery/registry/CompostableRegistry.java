...
public class CompostableRegistry {
    public static void registerCompostable() {
        ...
        ComposterBlock.COMPOSTABLES.put(ObjectRegistry.DARK_CHERRY_LEAVES.get().asItem(), 0.4F);
        ...
        ComposterBlock.COMPOSTABLES.put(ObjectRegistry.DARK_CHERRY_SAPLING.get().asItem(), 0.4F);
