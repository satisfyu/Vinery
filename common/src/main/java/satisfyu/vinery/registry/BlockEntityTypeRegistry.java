...
public class BlockEntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<StorageBlockEntity>> WINE_RACK_STORAGE_ENTITY = create("wine_rack_storage", () -> BlockEntityType.Builder.of(StorageBlockEntity::new, ObjectRegistry.CHERRY_DRAWER.get(), ObjectRegistry.CHERRY_CABINET.get(), ObjectRegistry.STORAGE_POT.get()).build(null));
