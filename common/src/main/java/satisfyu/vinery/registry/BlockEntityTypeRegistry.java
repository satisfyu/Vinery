...
public class BlockEntityTypeRegistry {
    ...
    public static final RegistrySupplier<BlockEntityType<StorageBlockEntity>> WINE_RACK_STORAGE_ENTITY = create("wine_rack_storage", () -> BlockEntityType.Builder.of(StorageBlockEntity::new, ObjectRegistry.WINE_RACK_3.get(), ObjectRegistry.WINE_RACK_5.get(), ObjectRegistry.CHERRY_DRAWER.get(), ObjectRegistry.CHERRY_CABINET.get()).build(null));
