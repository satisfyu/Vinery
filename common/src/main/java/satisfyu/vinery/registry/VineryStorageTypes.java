...
public class VineryStorageTypes {
	...
	public static void registerBlocks(Set<Block> blocks) {
		blocks.add(BlockRegistry.WINE_RACK_2.get());
		blocks.add(BlockRegistry.WINE_RACK_1.get());
		blocks.add(BlockRegistry.SHELF.get());
		blocks.add(BlockRegistry.WINE_BOX.get());
		blocks.add(BlockRegistry.FLOWER_BOX.get());
	}
}
