...
public class DataFixerRegistry {
    ...
    public static void init(){
        ...
        p.add("cherry_crate", "dark_cherry_crate");
        p.add("cherry_leaves", "dark_cherry_leaves");
        p.add("stripped_dark_cherry_log", "stripped_dark_cherry_log");
        p.add("stripped_dark_cherry_wood", "stripped_dark_cherry_wood");
        ...
        p.add("barrel", "crested_barrel");
        p.add("mccherry_wine_rack_big", "cherry_wine_rack_big");
        p.add("mccherry_wine_rack_small", "cherry_wine_rack_small");
        p.add("mccherry_wine_rack_mid", "cherry_wine_rack_mid");
    }
}
