...
public class MuleOldModel<T extends TraderMuleEntity> extends EntityModel<T> {
	...
	public MuleOldModel(ModelPart root) {
	...
	public void prepareMobModel(TraderMuleEntity entity, float f, float g, float h) {
		...
		this.leftFrontLeg.xRot = w - t * 0.5f * g * p;
		this.rightFrontLeg.xRot = w + t * 0.5f * g * p;
		this.leftHindLeg.xRot = y;
		this.rightHindLeg.xRot = z;
