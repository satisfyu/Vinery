...
public class StoveGuiHandler extends AbstractRecipeBookGUIScreenHandler {
	...
	public StoveGuiHandler(int syncId, Inventory playerInventory, Container inventory, ContainerData delegate) {
		super(VineryScreenHandlerTypes.STOVE_GUI_HANDLER.getOrNull(), syncId, 4, playerInventory, inventory, delegate);
	...
	private boolean isIngredient(ItemStack stack) {
		return this.world.getRecipeManager().getAllRecipesFor(VineryRecipeTypes.WOOD_FIRED_OVEN_RECIPE_TYPE.getOrNull())
