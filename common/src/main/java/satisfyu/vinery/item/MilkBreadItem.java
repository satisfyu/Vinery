...
public class MilkBreadItem extends Item {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag context) {
		if (Screen.hasShiftDown()) {
			tooltip.add(new TranslatableComponent("item.vinery.milkbread_line1.tooltip"));
			tooltip.add(new TranslatableComponent("item.vinery.milkbread_line2.tooltip"));
			tooltip.add(new TranslatableComponent("item.vinery.milkbread_line3.tooltip"));
