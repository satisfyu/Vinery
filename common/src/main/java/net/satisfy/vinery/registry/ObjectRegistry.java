...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Block> DARK_CHERRY_SAPLING = registerWithItem("dark_cherry_sapling", () -> new SaplingBlock(new TreeGrower("dark_cherry", Optional.of(VineryConfiguredFeatures.DARK_CHERRY_KEY), Optional.of(VineryConfiguredFeatures.DARK_CHERRY_VARIANT_KEY), Optional.empty()), BlockBehaviour.Properties.of().noCollission().randomTicks().instabreak().sound(SoundType.GRASS)));
    ...
    public static final RegistrySupplier<Block> APPLE_LEAVES = registerWithItem("apple_leaves", () -> new AppleLeaves(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES)));
    ...
    public static final RegistrySupplier<Block> DARK_CHERRY_CABINET = registerWithItem("dark_cherry_cabinet", () -> new CabinetBlockImp(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD), DoApiSoundEventRegistry.CABINET_OPEN, DoApiSoundEventRegistry.CABINET_CLOSE));
    public static final RegistrySupplier<Block> DARK_CHERRY_DRAWER = registerWithItem("dark_cherry_drawer", () -> new CabinetBlockImp(BlockBehaviour.Properties.of().strength(2.0F, 3.0F).sound(SoundType.WOOD), DoApiSoundEventRegistry.DRAWER_OPEN, DoApiSoundEventRegistry.DRAWER_CLOSE));
    ...
    public static final RegistrySupplier<Block> DIRT_SLAB = registerWithItem("dirt_slab", () -> new SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DIRT)));
    ...
    public static final RegistrySupplier<Item> CREEPERS_CRUSH_ITEM = registerItem("creepers_crush", () -> new DrinkBlockBigItem(CREEPERS_CRUSH.get(), getWineItemSettings(MobEffectRegistry.CREEPER_EFFECT, 1, 2)));
    ...
    public static final RegistrySupplier<Item> STRAW_HAT = registerItem("straw_hat", () -> new WinemakerHatItem(ArmorMaterialRegistry.WINEMAKER_ARMOR, ArmorItem.Type.HELMET, getSettings().rarity(Rarity.EPIC), VineryIdentifier.of("textures/models/armor/straw_hat.png")));
    ...
    public static final RegistrySupplier<Block> CALENDAR = registerWithItem("calendar", () -> new CalendarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FLOWER_POT)));
    ...
    public static void initItemsWithConfig() {
        VineryConfig config = VineryConfig.getConfigInstance();
        registerItem("chorus_wine", () -> new DrinkBlockBigItem(CHORUS_WINE.get(), getWineItemSettings(MobEffectRegistry.TELEPORT, config.wineEffectDuration(), config.wineEffectStrength())));
        ...
        registerItem("magnetic_wine", () -> new DrinkBlockBigItem(MAGNETIC_WINE.get(), getWineItemSettings(MobEffectRegistry.MAGNET, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("jo_special_mixture", () -> new DrinkBlockBigItem(JO_SPECIAL_MIXTURE.get(), getWineItemSettings(MobEffectRegistry.TRIPPY, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("cristel_wine", () -> new DrinkBlockBigItem(CRISTEL_WINE.get(), getWineItemSettings(MobEffectRegistry.EXPERIENCE_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        ...
        registerItem("red_wine", () -> new DrinkBlockSmallItem(RED_WINE.get(), getWineItemSettings(MobEffectRegistry.STAGGER_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("jellie_wine", () -> new DrinkBlockBigItem(JELLIE_WINE.get(), getWineItemSettings(MobEffectRegistry.JELLIE, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("stal_wine", () -> new DrinkBlockSmallItem(STAL_WINE.get(), getWineItemSettings(MobEffectRegistry.HEALTH_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("bolvar_wine", () -> new DrinkBlockSmallItem(BOLVAR_WINE.get(), getWineItemSettings(MobEffectRegistry.LAVA_WALKER, config.wineEffectDuration(), config.wineEffectStrength())));
        ...
        registerItem("eiswein", () -> new DrinkBlockBigItem(EISWEIN.get(), getWineItemSettings(MobEffectRegistry.FROSTY_ARMOR_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("chenet_wine", () -> new DrinkBlockBigItem(CHENET_WINE.get(), getWineItemSettings(MobEffectRegistry.CLIMBING_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("kelp_cider", () -> new DrinkBlockSmallItem(KELP_CIDER.get(), getWineItemSettings(MobEffectRegistry.WATER_WALKER, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("aegis_wine", () -> new DrinkBlockBigItem(AEGIS_WINE.get(), getWineItemSettings(MobEffectRegistry.ARMOR_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("clark_wine", () -> new DrinkBlockSmallItem(CLARK_WINE.get(), getWineItemSettings(MobEffectRegistry.IMPROVED_JUMP_BOOST, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("mellohi_wine", () -> new DrinkBlockBigItem(MELLOHI_WINE.get(), getWineItemSettings(MobEffectRegistry.LUCK_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("strad_wine", () -> new DrinkBlockBigItem(STRAD_WINE.get(), getWineItemSettings(MobEffectRegistry.RESISTANCE_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        ...
        registerItem("lilitu_wine", () -> new DrinkBlockBigItem(LILITU_WINE.get(), getWineItemSettings(MobEffectRegistry.PARTY_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("bottle_mojang_noir", () -> new DrinkBlockSmallItem(BOTTLE_MOJANG_NOIR.get(), getWineItemSettings(MobEffectRegistry.ARMOR_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        ...
        registerItem("count_roleester_shiraz", () -> new DrinkBlockBigItem(COUNT_ROLEESTER_SHIRAZ_WINE.get(), getWineItemSettings(MobEffectRegistry.SHIRAAZ_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
        registerItem("lamroc_wine", () -> new DrinkBlockSmallItem(LAMROC_WINE.get(), getWineItemSettings(MobEffectRegistry.TRADING_EFFECT, config.wineEffectDuration(), config.wineEffectStrength())));
    }
    ...
    private static Item.Properties getWineItemSettings(Holder<MobEffect> effect, int duration, int strength) {
        return new Item.Properties().food(wineFoodComponent(effect, duration, strength));
    }

    private static FoodProperties wineFoodComponent(Holder<MobEffect> effect, int duration, int strength) {
    ...
    private static BlockBehaviour.Properties getGrassSettings() {
        return BlockBehaviour.Properties.ofFullCopy(Blocks.GRASS_BLOCK).noOcclusion();
    }
    ...
    public static <T extends Block> RegistrySupplier<T> registerWithItem(String name, Supplier<T> block) {
        return Util.registerWithItem(BLOCKS, BLOCK_REGISTRAR, ITEMS, ITEM_REGISTRAR, VineryIdentifier.of(name), block);
    }

    public static <T extends Block> RegistrySupplier<T> registerWithoutItem(String path, Supplier<T> block) {
        return Util.registerWithoutItem(BLOCKS, BLOCK_REGISTRAR, VineryIdentifier.of(path), block);
    }

    public static <T extends Item> RegistrySupplier<T> registerItem(String path, Supplier<T> itemSupplier) {
        return Util.registerItem(ITEMS, ITEM_REGISTRAR, VineryIdentifier.of(path), itemSupplier);
    }
}
