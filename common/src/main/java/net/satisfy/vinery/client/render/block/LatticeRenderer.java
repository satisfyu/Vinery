...
public class LatticeRenderer implements BlockEntityRenderer<LatticeBlockEntity> {
    ...
    public LatticeRenderer(BlockEntityRendererProvider.Context context) {
        ...
        this.lattice_floor = lattice_floor;
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition mesh = lattice_wall.addOrReplaceChild("mesh", CubeListBuilder.create().texOffs(0, 30).addBox(-30.0F, 0.0F, 2.0F, 16.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 30).addBox(-30.0F, -10.0F, 2.0F, 16.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(28, 14).mirror().addBox(-26.0F, -12.0F, 2.0F, 2.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(28, 14).mirror().addBox(-20.0F, -12.0F, 2.0F, 2.0F, 16.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(22.0F, -4.0F, 5.0F));
        ...
        PartDefinition corner_braces_right_top_r1 = corner_braces_right.addOrReplaceChild("corner_braces_right_top_r1", CubeListBuilder.create().texOffs(4, 16).addBox(-7.99F, -6.0F, -5.5F, 1.98F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(14.0F, -7.0F, -1.0F, -0.7854F, 0.0F, 0.0F));
        ...
        PartDefinition corner_braces_left_bottom_r1 = corner_braces_left.addOrReplaceChild("corner_braces_left_bottom_r1", CubeListBuilder.create().texOffs(4, 16).addBox(-7.99F, -6.0F, -5.5F, 1.98F, 1.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, -1.0F, -0.7854F, 0.0F, 0.0F));
        ...
        PartDefinition cross_brace_1_r1 = lattice_floor.addOrReplaceChild("cross_brace_1_r1", CubeListBuilder.create().texOffs(16, 2).addBox(-4.0F, -29.0F, -3.0F, 2.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 28.0F, 1.0F, 0.0F, -1.5708F, 0.0F));

        PartDefinition cross_brace_2_r1 = lattice_floor.addOrReplaceChild("cross_brace_2_r1", CubeListBuilder.create().texOffs(16, 2).addBox(-4.0F, -29.0F, -3.0F, 2.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 28.0F, 5.0F, 0.0F, -1.5708F, 0.0F));

        PartDefinition cross_brace_3_r1 = lattice_floor.addOrReplaceChild("cross_brace_3_r1", CubeListBuilder.create().texOffs(16, 2).addBox(-4.0F, -29.0F, -3.0F, 2.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 28.0F, -3.0F, 0.0F, -1.5708F, 0.0F));

        PartDefinition cross_brace_4_r1 = lattice_floor.addOrReplaceChild("cross_brace_4_r1", CubeListBuilder.create().texOffs(16, 2).addBox(-4.0F, -29.0F, -3.0F, 2.0F, 0.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 28.0F, 9.0F, 0.0F, -1.5708F, 0.0F));

        PartDefinition support_floor_left_r1 = lattice_floor.addOrReplaceChild("support_floor_left_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-16.0F, -16.0F, 14.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition hanging_2_r1 = grape_cluster_floor.addOrReplaceChild("hanging_2_r1", CubeListBuilder.create().texOffs(48, 66).addBox(-7.0F, -11.5F, -1.0F, 8.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.8284F, 18.0F, -4.4142F, 0.0F, 0.7854F, 0.0F));

        PartDefinition hanging_1_r1 = grape_cluster_floor.addOrReplaceChild("hanging_1_r1", CubeListBuilder.create().texOffs(48, 52).addBox(-7.0F, -9.5F, -1.0F, 8.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4142F, 16.0F, -0.1716F, 0.0F, -0.7854F, 0.0F));
