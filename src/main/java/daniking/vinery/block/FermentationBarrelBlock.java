...
public class FermentationBarrelBlock extends HorizontalFacingBlock implements BlockEntityProvider {
    // TODO: Deal with voxel shape situation
    private static final Supplier<VoxelShape> voxelShapeSupplier = () -> VoxelShapes.union(
            createCuboidShape(0.4375, 1.0625, 0.4375, 0.5625, 1.25, 0.5625),
            createCuboidShape(0.5, 0.1875, 1.125, 0.5625, 0.6875, 1.1875),
            createCuboidShape(6.75, 5.75, 18,9.25, 8.25, 20),
            createCuboidShape(0.0625, 0.1875, 0, 0.9375, 1.0625, 1),
            createCuboidShape(0.0625, 0, 0.75, 0.9375, 0.125, 0.9375),
            createCuboidShape(0.0625, 0, 0.0625, 0.9375, 0.125, 0.25),
            createCuboidShape(0.125, 0.125, 0.75, 0.875, 0.1875, 0.9375),
            createCuboidShape(0.125, 0.125, 0.0625, 0.875, 0.1875, 0.25),
            createCuboidShape(0.125, 0.0625, 0.25, 0.1875, 0.125, 0.75),
            createCuboidShape(0.8125, 0.0625, 0.25, 0.875, 0.125, 0.75),
            createCuboidShape(0.4375, 0.3125, 1, 0.625, 0.5, 1.25));
