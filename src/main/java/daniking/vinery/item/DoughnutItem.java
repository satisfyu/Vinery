...
public class DoughnutItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("item.vinery.doughnut_line1.tooltip"));
            tooltip.add(Text.translatable("item.vinery.doughnut_line2.tooltip"));
            tooltip.add(Text.translatable("item.vinery.doughnut_line3.tooltip"));
