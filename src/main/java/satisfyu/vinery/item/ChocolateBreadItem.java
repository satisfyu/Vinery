...
public class ChocolateBreadItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            tooltip.add(new TranslatableText("item.vinery.chocolatebread_line1.tooltip"));
            tooltip.add(new TranslatableText("item.vinery.chocolatebread_line2.tooltip"));
            tooltip.add(new TranslatableText("item.vinery.chocolatebread_line3.tooltip"));
