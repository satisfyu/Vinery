...
public class VineryEffects {
    ...
    static {
        ...
        IMPROVED_JUMP_BOOST = registerEffect("improved_jump_boost", new ImprovedEffect(StatusEffectCategory.BENEFICIAL, 0x90F891)); //TODO
        IMPROVED_STRENGTH = registerEffect("improved_strength", new ImprovedEffect(StatusEffectCategory.BENEFICIAL, 0xB87334)
                ...
                .addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "649DC064-6A60-45F9-C0BE-CB923001D7A9", 3.0, EntityAttributeModifier.Operation.ADDITION));
        ...
        IMPROVED_LUCK = registerEffect("improved_luck", new ImprovedEffect(StatusEffectCategory.BENEFICIAL, 0x87AE22)
                .addAttributeModifier(EntityAttributes.GENERIC_LUCK, "0C4EF750-C1D4-11ED-AFA1-0242AC120002", 1.0, EntityAttributeModifier.Operation.ADDITION)
