...
public class VineryBlockEntityTypes {
    ...
    public static final BlockEntityType<FlowerBoxBlockEntity> FLOWER_POT_ENTITY = create("flower_pot", FabricBlockEntityTypeBuilder.create(FlowerBoxBlockEntity::new, ObjectRegistry.FLOWER_POT).build());
