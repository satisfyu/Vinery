...
public class SideTipButton extends ButtonWidget  {
    ...
    public SideTipButton(int x, int y, PressAction pressAction) {
        this(x, y, 0, 0, 18, new VineryIdentifier("textures/gui/recipe_book.png"), 20, 36, pressAction);
    }
    public SideTipButton(int x, int y, int u, int v, int hoveredVOffset, Identifier texture, int textureWidth , int textureHeight, PressAction pressAction) {
